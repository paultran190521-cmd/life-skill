...
assert.match(app, /function cleanTimeSlotLabel\(label: string\)/);
assert.match(app, /replace\(\/\\s\+từ\\s\+\\d\{1,2\}:\\d\{2\}\\s\*\$\/i, ""\)/);
assert.match(app, /cleanTimeSlotLabel\(meta\.slot\.label\)/);
